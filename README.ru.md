...
| 📚 | Документация для IDE | Подробные docstring для каждого публичного класса, метода, результата и исключения. |
...
│   └── test_documentation.py     # Контроль публичных docstring
└── examples/
    └── web_mixer/
